...
/*   Updated: 2022/12/12 16:13:54 by nfauconn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_scene(t_scene *scene, t_img *img)
{
	...
	right->transform = matrix_mult(translation(1.5, 0.5, -0.5), scaling(right->specs.radius, right->specs.radius, right->specs.radius));
